...
Block Parser::parseBlock()
{
	...
	changeDebugDataLocationEnd(block.debugData, currentLocation().end);
	advance();
	return block;
}
...
Statement Parser::parseStatement()
{
	...
	case Token::Switch:
	{
		...
		changeDebugDataLocationEnd(_switch.debugData, _switch.cases.back().body.debugData->location.end);
	...
	case Token::AssemblyAssign:
	{
		...
		changeDebugDataLocationEnd(assignment.debugData, locationOf(*assignment.value).end);
...
Case Parser::parseCase()
{
	...
	changeDebugDataLocationEnd(_case.debugData, _case.body.debugData->location.end);
	return _case;
}
...
ForLoop Parser::parseForLoop()
{
	...
	changeDebugDataLocationEnd(forLoop.debugData, forLoop.body.debugData->location.end);
...
variant<Literal, Identifier> Parser::parseLiteralOrIdentifier()
{
	...
	case Token::FalseLiteral:
	{
		...
		if (currentToken() == Token::Colon)
		{
			...
			changeDebugDataLocationEnd(literal.debugData, currentLocation().end);
...
VariableDeclaration Parser::parseVariableDeclaration()
{
	...
	if (currentToken() == Token::AssemblyAssign)
	{
		...
		changeDebugDataLocationEnd(varDecl.debugData, locationOf(*varDecl.value).end);
	}
	else
		changeDebugDataLocationEnd(varDecl.debugData, varDecl.variables.back().debugData->location.end);
...
FunctionDefinition Parser::parseFunctionDefinition()
{
	...
	changeDebugDataLocationEnd(funDef.debugData, funDef.body.debugData->location.end);
...
FunctionCall Parser::parseCall(variant<Literal, Identifier>&& _initialOp)
{
	...
	changeDebugDataLocationEnd(ret.debugData, currentLocation().end);
	expectToken(Token::RParen);
	return ret;
}
...
TypedName Parser::parseTypedName()
{
	...
	{
		expectToken(Token::Colon);
		changeDebugDataLocationEnd(typedName.debugData, currentLocation().end);
