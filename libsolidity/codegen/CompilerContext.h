...
public:
	...
	void optimise(OptimiserSettings const& _settings) {
		auto translatedSettings = evmasm::Assembly::OptimiserSettings::translate(_settings, m_evmVersion);
		m_asm->optimise(translatedSettings);
	}
